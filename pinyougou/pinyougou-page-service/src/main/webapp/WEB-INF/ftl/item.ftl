				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
                        ...
                        <div id="preview" class="spec-preview">
							<#if (imageList?size>0)>
                                <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" style="width: 100px;height: 100px" /></span>
							</#if>
						</div>
						<!--下方的缩略图-->
						...
						<div id="specification" class="summary-wrap clearfix">
                                ...
                                <dl>
									...
									<#list  specification.attributeValue as item >
                                   		 <dd><a href="javascript:;"
												...
												ng-click="selectSpecification('${specification.attributeName}','${item}')">${item}</a></dd>
									</#list>
                                </dl>
							</#list>
						</div>
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" target="_blank" class="sui-btn  btn-danger addshopcar"
										ng-click="addToCart()">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
